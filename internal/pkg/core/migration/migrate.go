...
func (mc *MigrationCmd) AddSeed(sf ...SeedFunc) {
...
func (mc *MigrationCmd) gormigrate() *gormigrate.Gormigrate {
	...
	options.TableName = "sys_migrations"

	return gormigrate.New(database.GetInstance(), options, mc.MigrationCollection)
}
